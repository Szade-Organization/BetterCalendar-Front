...
const Notification: React.FC<NotificationProps> = ({ type, message, onClose }) => {
    ...
    const typeStyles = {
        [NotificationType.SUCCESS]: "text-green-500 bg-green-100 dark:bg-green-800 dark:text-green-200",
        [NotificationType.DANGER]: "text-red-500 bg-red-100 dark:bg-red-800 dark:text-red-200",
        [NotificationType.WARNING]: "text-orange-500 bg-orange-100 dark:bg-orange-700 dark:text-orange-200"
    };
