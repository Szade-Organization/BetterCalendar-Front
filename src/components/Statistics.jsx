...
const Statistics = () => {
    ...
    return (
        <div className='p-5 bg-white rounded-3xl'>
            <div className='m-10 text-3xl font-semibold text-gray-700'>Statistics</div>
            <div className="flex flex-wrap">
                <CardStatistics icon={activityicon} number={100} text="Total activities" />
            ...
            <div className="m-10 grid grid-cols-1 sm:grid-cols-2 gap-8 items-end">
                <div>
                    <div className='flex flex-row'>
                        <div className='mb-5 text-2xl font-semibold text-gray-700'>Completed Activites</div>
                        <div className='mx-5 mb-5 text-2xl font-semibold text-green-700'>75%</div>
                    </div>
                    <Chart title={"Com"} type="doughnut" data={donutData} />
                </div>
                <div>
                    <div className='mb-5 text-2xl font-semibold text-gray-700'>Category Breakdown</div>
